...
const Statistics = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      {/* Header */}
      <div className="text-center pb-10 px-4 lg:px-0">
        <h1 className="text-2xl md:text-4xl py-4 font-bold">
          Social Statistics
        </h1>
      ...
      <div
        ...
        className="flex flex-col lg:flex-row px-4 md:px-6 lg:px-0 my-10 gap-6 lg:gap-16"
      >
        {/* Left Images */}
        ...
        <div className="flex flex-col gap-4 md:gap-5 mt-auto">
          <p className="uppercase text-[#FF4150] text-base md:text-lg">
            @alikamaya
          </p>
              ...
              {stats ? (
                <>
                  <h1 className="text-2xl md:text-4xl font-semibold text-red-500">
                    {stats.subscribers}{" "}
                    <span className="text-lg md:text-2xl font-normal text-black">
                      subscribers
                    </span>
                  </h1>
                  <h1 className="text-2xl md:text-4xl font-semibold text-red-500">
      ...
      <div className="px-4 md:px-6 lg:px-0 flex flex-col lg:flex-row gap-6 text-center md:text-left">
        {/* Left Side */}
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          <div className="flex justify-evenly text-center">
            <div>
              <h1 className="text-[#FF4150] text-4xl md:text-5xl font-bold">
                OK
              </h1>
              <h1 className="text-sm md:text-xl italic text-[#797979] pt-4">
                followers
              </h1>
            </div>
            <div>
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex flex-col md:flex-row gap-6 pt-4">
            <div>
              ...
              />
              <h1 className="text-xl md:text-2xl font-semibold pt-3">
                Alika X Tempest
              </h1>
