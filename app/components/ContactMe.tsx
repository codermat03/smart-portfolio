...
const ContactMe = () => {
    return (
        <div className="relative w-full h-screen flex items-center justify-center">
            ...
            {/* Content */}
            <div className="relative max-w-7xl mx-auto flex flex-wrap items-center justify-between p-10 rounded-lg bg-[#00000065]">
                {/* Left Side */}
                <div className="w-full md:w-1/2 text-white space-y-6">
                    <h2 className="md:text-4xl text-3xl font-bold">Join with me</h2>
                    <p className="md:text-lg text-base">
                        Unlock your creativity with **Mukta Art & Craft**. Join me on this artistic journey!
                    </p>
